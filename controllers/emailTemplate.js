...
const getOTPEmailTemplate = (name, otp) => {
  ...
  const getLoginOTPEmailTemplate = (name, otp) => {
    return `
      Dear ${name},
  
      We have received a request to login your account. Please use the following OTP (One-Time Password) to verify your email and complete your login:
